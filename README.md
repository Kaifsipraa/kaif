...
<p align="center">
  <img src="https://img.shields.io/badge/Author-BONA--Venture-cyan?style=flat-square">
...
```
$ git clone https://github.com/kaifsipraa/BONAVENTURE.git
```

- Change to cloned directory and run `bona.sh` -
```
$ cd BONAVENTURE
$ bash bona.sh
```
...
### Run on Docker
```
$ docker pull kaifsipraa/BONAVENTURE
$ docker run --rm -it kaifsipraa/BONAVENTURE
```

### Dependencies

**`Bphisher`** requires following programs to run properly - 
- `php`
- `wget`
- `curl`
- `git`

> All the dependencies will be installed automatically when you run `Bphisher` for the first time.
